package pro.sky.java.course2_OOP.Lesson8_hash_function;

import pro.sky.java.course2_OOP.Lesson8_hash_function.Driver.*;
import pro.sky.java.course2_OOP.Lesson8_hash_function.Mechanic.Mechanic;
import pro.sky.java.course2_OOP.Lesson8_hash_function.transport.Bus;
import pro.sky.java.course2_OOP.Lesson8_hash_function.transport.Car;
import pro.sky.java.course2_OOP.Lesson8_hash_function.transport.Transport;
import pro.sky.java.course2_OOP.Lesson8_hash_function.transport.Truck;
...
public class Main {
    ...
    public static void main(String[] args) throws IllegalTypeOfLicense {
        ...
        Truck check = new Truck("Check", "N120", 166.0, Truck.LoadCapacity.N1, new LicenseC("Jan Jack", true, 7));
