...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //чекнуть enums на невозможность записи неверных значений,
        //добавить енамы в класс транспорт и во все наследники
        //возможно переписать toString у еnum чтобы работало через оператор swich
    }
}
