...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Car audiA8 = new Car("Audi", "A8 50 L TDI quattro", 2020, "Германия", "чёрный", 3.0f);
        Car bMW = new Car("BMW", "Z8", 2021, "Германия", "чёрный", 3.0f);
        Car kia = new Car("Kia", "Sportage 4-го поколения", 2018, "Южная корея", "красный", 2.4f);
        Car hyundaiAvante = new Car("Hyundai", "Avante", 2016, "Южная корея", "орнжевый", 1.6f);
